...
/* DAC */
#define DAC__0__INTTYPE CYREG_PICU0_INTTYPE0
#define DAC__0__MASK 0x01u
#define DAC__0__PC CYREG_PRT0_PC0
#define DAC__0__PORT 0u
#define DAC__0__SHIFT 0u
#define DAC__AG CYREG_PRT0_AG
#define DAC__AMUX CYREG_PRT0_AMUX
#define DAC__BIE CYREG_PRT0_BIE
#define DAC__BIT_MASK CYREG_PRT0_BIT_MASK
#define DAC__BYP CYREG_PRT0_BYP
#define DAC__CTL CYREG_PRT0_CTL
#define DAC__DM0 CYREG_PRT0_DM0
#define DAC__DM1 CYREG_PRT0_DM1
#define DAC__DM2 CYREG_PRT0_DM2
#define DAC__DR CYREG_PRT0_DR
#define DAC__INP_DIS CYREG_PRT0_INP_DIS
#define DAC__INTTYPE_BASE CYDEV_PICU_INTTYPE_PICU0_BASE
#define DAC__LCD_COM_SEG CYREG_PRT0_LCD_COM_SEG
#define DAC__LCD_EN CYREG_PRT0_LCD_EN
#define DAC__MASK 0x01u
#define DAC__PORT 0u
#define DAC__PRT CYREG_PRT0_PRT
#define DAC__PRTDSI__CAPS_SEL CYREG_PRT0_CAPS_SEL
#define DAC__PRTDSI__DBL_SYNC_IN CYREG_PRT0_DBL_SYNC_IN
#define DAC__PRTDSI__OE_SEL0 CYREG_PRT0_OE_SEL0
#define DAC__PRTDSI__OE_SEL1 CYREG_PRT0_OE_SEL1
#define DAC__PRTDSI__OUT_SEL0 CYREG_PRT0_OUT_SEL0
#define DAC__PRTDSI__OUT_SEL1 CYREG_PRT0_OUT_SEL1
#define DAC__PRTDSI__SYNC_OUT CYREG_PRT0_SYNC_OUT
#define DAC__PS CYREG_PRT0_PS
#define DAC__SHIFT 0u
#define DAC__SLW CYREG_PRT0_SLW
...
/* Pin_SW */
#define Pin_SW__0__INTTYPE CYREG_PICU2_INTTYPE7
#define Pin_SW__0__MASK 0x80u
#define Pin_SW__0__PC CYREG_PRT2_PC7
...
/* uart_interrupt */
#define uart_interrupt__INTC_CLR_EN_REG CYREG_NVIC_CLRENA0
#define uart_interrupt__INTC_CLR_PD_REG CYREG_NVIC_CLRPEND0
#define uart_interrupt__INTC_MASK 0x02u
#define uart_interrupt__INTC_NUMBER 1u
#define uart_interrupt__INTC_PRIOR_NUM 7u
#define uart_interrupt__INTC_PRIOR_REG CYREG_NVIC_PRI_1
#define uart_interrupt__INTC_SET_EN_REG CYREG_NVIC_SETENA0
#define uart_interrupt__INTC_SET_PD_REG CYREG_NVIC_SETPEND0
